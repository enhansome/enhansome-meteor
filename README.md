...
* [matb33:collection-hooks](https://github.com/Meteor-Community-Packages/meteor-collection-hooks) ⭐ 656 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-03 - Extends Mongo.Collection with before/after hooks for insert/update/remove/find/findOne.
...
* [monti-apm-agent](https://github.com/monti-apm/monti-apm-agent) ⭐ 48 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-26 - Performance Monitoring for Meteor
...
* [driftyco:ionic](https://github.com/driftyco/ionic) ⭐ 52,646 | 🐛 592 | 🌐 TypeScript | 📅 2026-09-04 - Official Ionic support for Meteor.
...
* [meteor-zsh](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#meteor) ⭐ 189,602 | 🐛 442 | 🌐 Shell | 📅 2026-09-06 - Completion for the meteor command.
...
* [maka-cli](https://github.com/maka-io/maka-cli) ⭐ 0 | 🐛 0 | 📅 2026-09-06 - Maka-CLI is a command line tool, which organizes a web application's file structure and automates everyday package installation tasks for various application frameworks.
...
* [Wekan](https://github.com/wekan/wekan) ⭐ 21,073 | 🐛 280 | 🌐 JavaScript | 📅 2026-09-06 - Open source Trello-like kanban.
...
* [Unchained Shop](https://github.com/unchainedshop/unchained) ⭐ 201 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-03 - Open source Commerce platform developed with Meteor.
